...
const MSG_ARCH_FOLDER_NOT_SUPPORTED = "A pasta 'arch' não é mais suportada! Veja http://goo.gl/gfFJzU para mais informações"
const MSG_ARCHIVING_CORE_CACHE = "Arquivando o núcleo compilado (caching) em: {0}"
const MSG_BOARD_UNKNOWN = "Placa {0} (Plataforma {1}, pacote {2}) is unknown"
